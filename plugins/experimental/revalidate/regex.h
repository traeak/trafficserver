...
public:
  enum Flag {
    CASE_INSENSITIVE = 0x01, // default is case sensitive
    UNANCHORED       = 0x02, // default (for DFA) is to anchor at the first matching position
    ANCHORED         = 0x04, // default (for Regex) is unanchored
  };
