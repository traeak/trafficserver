...
tr.Processes.Default.Streams.stdout.Content = Testers.ContainsExpression("X-Cache: miss", "expected cache miss")
...
tr.Processes.Default.Streams.stdout.Content = Testers.ContainsExpression("X-Cache: hit-fresh", "expected cache hit-fresh")
tr.StillRunningAfter = ts
...
tr.Processes.Default.Streams.stdout.Content = Testers.ContainsExpression("X-Cache: hit-stale", "expected cache hit-stale")
tr.StillRunningAfter = ts
